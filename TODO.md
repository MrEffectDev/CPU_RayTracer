...
- [x] 3d models — loading models (obj/gltf) as sets of triangles
- [x] BVH — acceleration structure, without it models with lots of triangles will take forever to render
...
- [x] configurable render settings through the UI (SPP, max depth, resolution) without rebuilding
